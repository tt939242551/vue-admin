<template>
  <div class="home">
      <div id="topbar">
        ...
        <div class="inputbox"><Input size="small" search class="topsearch"  v-model="models[3]"  enter-button="搜索" placeholder="搜索" /></div>
...
export default {
    ...
    methods:{
     getselectlist(){
       ...
       let params={page:this.page,pageSize:this.pageSize,sex:this.models[0],stardate:arr[0],enddate:arr[1]}
